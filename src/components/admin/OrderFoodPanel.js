  ...
  return (
    <div id="order-food-panel">
      ...
      <div className="bg-white rounded-xl shadow-md overflow-hidden">
        ...
        {/* --- THIS IS THE FIX --- */}
        {/* We wrap the table in this div to make it scroll on mobile */}
        <div className="overflow-x-auto">
          <table className="w-full min-w-[800px]"> {/* min-w-[800px] ensures it scrolls on medium screens too */}
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {orders.map((order) => (
                <tr key={order.id}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap"><div className="text-sm text-gray-900">₹{order.totalAmount.toLocaleString()}</div></td>
